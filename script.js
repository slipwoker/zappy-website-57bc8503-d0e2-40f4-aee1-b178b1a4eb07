  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && !value) {
        showError(field, isRTL ? `${name} مطلوب` : `${name} is required`);
        return false;
      }
      ...
      if (field.type === 'email' && value) {
        ...
        if (!emailRegex.test(value)) {
          showError(field, isRTL ? 'البريد الإلكتروني غير صالح' : 'Please enter a valid email');
          return false;
        }
      }
      ...
      if (field.type === 'tel' && value) {
        ...
        if (!phoneRegex.test(value)) {
          showError(field, isRTL ? 'رقم الهاتف غير صالح' : 'Please enter a valid phone number');
          return false;
        }
      }
      ...
      if (field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'))) {
        ...
        showError(field, isRTL ? `يجب أن يكون ${minLen} أحرف على الأقل` : `Must be at least ${minLen} characters`);
        return false;
      }
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function(el) {
      ...
      if (el.classList.contains('fade-in-up')) {
        ...
        el.style.transform = document.documentElement.dir === 'rtl' ? 'translateX(30px)' : 'translateX(-30px)';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '57bc8503-d0e2-40f4-aee1-b178b1a4eb07',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '57bc8503-d0e2-40f4-aee1-b178b1a4eb07';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57bc8503-d0e2-40f4-aee1-b178b1a4eb07';
